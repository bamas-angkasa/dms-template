import type { Metadata,Viewport } from "next";import { Plus_Jakarta_Sans } from "next/font/google";import { MobileAppShell } from "@/components/layout/mobile-app-shell";import "./globals.css";import "../styles/features.css";
